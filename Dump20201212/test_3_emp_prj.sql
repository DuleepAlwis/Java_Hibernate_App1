...
--
-- Table structure for table `emp_prj`
--

DROP TABLE IF EXISTS `emp_prj`;
...
--
-- Dumping data for table `emp_prj`
--

LOCK TABLES `emp_prj` WRITE;
/*!40000 ALTER TABLE `emp_prj` DISABLE KEYS */;
/*!40000 ALTER TABLE `emp_prj` ENABLE KEYS */;
UNLOCK TABLES;
